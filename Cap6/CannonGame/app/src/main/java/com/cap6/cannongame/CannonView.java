...
public class CannonView extends SurfaceView 
   ...
   private Activity activity; // para exibir a caixa de diálogo Game Over na
                              // thread da interface gráfica do usuário
   ...
   public CannonView(Context context, AttributeSet attrs) {
      ...
      // registra o receptor de SurfaceHolder.Callback
   ...
   private void updatePositions(double elapsedTimeMS) {
      ...
      // configura a posição da barreira
   ...
   public void drawGameElements(Canvas canvas) {
      ...
      // desenha o alvo
      for (int i = 0; i < TARGET_PIECES; i++) {
         // se essa parte do alvo não foi atingida, a desenh
         if (!hitStates[i]) {
   ...
   private void showGameOverDialog(final int messageId) {
      ...
      // em uma thread de interface gráfica do usuário, usa FragmentManager para
      // exibir o componente DialogFragment
